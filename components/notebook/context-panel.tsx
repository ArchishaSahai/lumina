...
type Props = { notebookId: string; title: string; description: string; sources: NotebookSource[]; updatedAt: string; highlightedSourceIds: string[]; onGenerateSummary?: () => void };

export function ContextPanel({ notebookId, title, description, sources, updatedAt, highlightedSourceIds, onGenerateSummary }: Props) {
  ...
  return (
    <aside className="min-h-0 overflow-y-auto border-t border-white/[.08] bg-zinc-950/65 p-4 xl:border-t-0 xl:border-l">
      ...
      <QuickActions onGenerateSummary={onGenerateSummary} />
