...
const actions = [{ label: "Generate podcast", icon: Headphones }, { label: "Generate roadmap", icon: ListTree }, { label: "Generate summary", icon: Files }, { label: "Settings", icon: Settings }];
